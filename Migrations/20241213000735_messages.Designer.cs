...
namespace social_oc_api.Migrations
{
    ...
    [Migration("20241213000735_messages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("social_oc_api.Models.Domain.Chat.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ParticipantSecondId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ParticipantSecondId");

                    b.ToTable("Conversations");
                });

            modelBuilder.Entity("social_oc_api.Models.Domain.Chat.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("social_oc_api.Models.Domain.RequestFollower", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("social_oc_api.Models.Domain.Chat.Conversation", b =>
                {
                    b.HasOne("social_oc_api.Models.Domain.ApplicationUser", "ParticipantOne")
                        .WithMany()
                        .HasForeignKey("ParticipantOneId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("social_oc_api.Models.Domain.ApplicationUser", "ParticipantSecond")
                        .WithMany()
                        .HasForeignKey("ParticipantSecondId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ParticipantOne");

                    b.Navigation("ParticipantSecond");
                });

            modelBuilder.Entity("social_oc_api.Models.Domain.Chat.Message", b =>
                {
                    b.HasOne("social_oc_api.Models.Domain.Chat.Conversation", "Conversation")
                        .WithMany()
